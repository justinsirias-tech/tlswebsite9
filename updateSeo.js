...
async function main() {
  console.log("Fetching hotels and apartments...");
  ...
  for (const loc of locations) {
    console.log(`\nGenerating 2000-word SEO article for: ${loc.name} (${loc.city})`);
    ...
    I am giving you a location: Name: "${loc.name}", City: "${loc.city}", Type: "${loc.type}".
    ...
    1. A detailed, glowing review of the location (${loc.name}), its architecture, luxury amenities, and what makes it special in ${loc.city}.
    2. A comprehensive guide to the surrounding neighborhood, tourist attractions, business hubs, and lifestyle in ${loc.city}.
    3. The absolute necessity of premium garment care for guests staying at ${loc.name}, whether for business meetings, high-end dinners, or humid weather.
    ...
    "Welcome to ${loc.name}
    An oasis of luxury in the vibrant heart of ${loc.city}, ${loc.name} offers guests an unforgettable experience. From world-class dining to stunning architecture and exceptional service, every detail of your stay is designed to be spectacular. While you spend your days exploring nearby attractions, allow us to take care of the essentials.
    That Laundry Shop is proud to partner with discerning guests staying at ${loc.name} to provide unparalleled garment care. Whether you need a simple laundry service or specialized dry cleaning, we ensure you always look your absolute best without lifting a finger.
    Ultimate Convenience: Direct Pickup & Delivery
    Your time in ${loc.city} is incredibly valuable... That is why we offer a seamless, white-glove pickup and delivery laundry service directly to your hotel room. Simply schedule a pickup, and our professional concierge will arrive at the lobby of ${loc.name} to collect your garments. Within hours, your clothes will be returned to you—fresh, perfectly pressed, and meticulously packaged.
    The Final Touch: Why Luxury Guests Choose Us
    When staying at a premium establishment like ${loc.name}, you expect nothing less than perfection. That Laundry Shop meets those exacting standards through our commitment to premium fabric care.
    ...
    English-Speaking Concierge: We provide seamless, clear communication from the moment you book our laundry service until your clothes are delivered back to ${loc.name}.
    Experience the luxury of professionally cleaned clothes without ever leaving the comfort of ${loc.name}. Book your dry cleaning and laundry service pickup today and let us add the perfect finishing touch to your stay in ${loc.city}."
    ...
    try {
      ...
      console.log(`✅ Updated ${loc.name} successfully!`);
    } catch (e) {
